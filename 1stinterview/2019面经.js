...
一年前，也许你搞清楚闭包，this，原型链，就能获得认可，但是现在显然是不行了。本文梳理出了一些面试中有一定难度的高频原生JS问题，部分知识点可能你之前从未关注过，或者看到了，却没有仔细研究，但是它们却非常重要。本文将以真实的面试题的形式来呈现知识点，大家在阅读时，建议先思考再看作者的答案。尽管，本文所有的答案，都是作者在翻阅各种资料，思考并验证之后，才给出的(绝非简单的复制粘贴)。但因水平有限，答案未必最优，欢迎大家给作者留言探讨。
...
本文的写成耗费了非常多的时间，在这个过程中，作者也学习到了很多知识，谢谢各位小伙伴愿意花费宝贵的时间阅读本文，如果本文给了您一点帮助或者是启发，请不要吝啬你的“在看”。
