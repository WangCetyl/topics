/*
  交换变量
  在不使用ES6方法的情况下，不使用中间变量交换 a，b的值
  思路同上032题，先变成字符串，交换位置，在变成number
...
function varexchange(a,b) {
	
	return {
		a:Number((String(a)+' '+String(b)).split(' ').reverse()[0]),
		b:Number((String(a)+' '+String(b)).split(' ').reverse()[1])
	}
	
}


console.log(varexchange(a,b).a,varexchange(a,b).b)