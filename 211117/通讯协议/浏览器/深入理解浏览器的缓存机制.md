 ![图片](https://mmbiz.qpic.cn/mmbiz_gif/KfGu3WwVIa34PY1H5NVPPAms6s3bIX97xmOkiaMNTBJLzwRyTZcTiaM5F8XgRy5kkYIUCoFEshZt5skUrUp5GJhw/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)   戳蓝字「前端技术优选」关注我们哦！
...
**如需获取思维导图或想阅读更多优质文章请猛戳GitHub博客**![图片](https://mmbiz.qpic.cn/mmbiz_png/zewrLkrYfsO5XKSbiaribdfKJBC7oeG7ZW3q4kuD53laVQnAtZWblJPLmscjdDbiaKLklFIGVMpNazUG2jIGOOsyQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
当我们访问过页面以后，再次刷新页面，可以发现很多数据都来自于内存缓存![图片](https://mmbiz.qpic.cn/mmbiz_png/zewrLkrYfsO5XKSbiaribdfKJBC7oeG7ZWTt2QEicsVbfXee6ymnJy5g4sILuUaLEJrIuCkDNqbkFicbEl4ia0RX1kQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
**Expires 是 HTTP/1 的产物，受限于本地时间，如果修改了本地时间，可能会造成缓存失效**。`Expires:Wed,22Oct201808:41:00GMT`表示资源会在 Wed, 22 Oct 2018 08:41:00 GMT 后过期，需要再次请求。
...
**min-fresh**：能够容忍的最小新鲜度。min-fresh标示了客户端不愿意接受新鲜度不多于当前的age加上min-fresh设定的时间之和的响应。![图片](https://mmbiz.qpic.cn/mmbiz_png/zewrLkrYfsO5XKSbiaribdfKJBC7oeG7ZWnldIrsRicicy3B2QZJm8BLo02fiboS0QFU677eTaZgIibfFYNyddXfL71A/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
-   协商缓存生效，返回304和Not Modified
    ...
    ![图片](https://mmbiz.qpic.cn/mmbiz_png/zewrLkrYfsO5XKSbiaribdfKJBC7oeG7ZWQKCNqtbNEAVUWeh8S6KbMYL0hDm7LD8GHAzRQQXPicIrog7meyNJY7Q/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
    
-   协商缓存失效，返回200和请求结果
    

![图片](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)协商缓存可以通过设置两种 HTTP Header 实现：Last-Modified 和 ETag 。   
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/C94aicOicyXpJh8UXgEvxqrujppTsCiaZnGsPqBvA8B3RUOTf4wFElXhlhFLzcDeJk8vs0I6mUTqjww7QlIy1pJkQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
