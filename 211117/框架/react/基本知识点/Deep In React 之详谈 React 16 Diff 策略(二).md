> 文章首发于[个人博客](https://link.zhihu.com/?target=http%3A//www.taoweng.site/)

这是我 Deep In React 系列的第二篇文章，如果还没有读过的强烈建议你先读第一篇：**[详谈 React Fiber 架构(1)](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/dONYc-Y96baiXBXpwh1w3A)**。
...
-   [别再说虚拟 DOM 快了，要被打脸的](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/XR3-3MNCYY2pg6yVwVQohQ)
-   [深入理解虚拟 DOM，它真的不快](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/cz5DBpqFiadL4IQofiWY3A)
...
Diff 就是新旧节点的对比，在[上一篇](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/dONYc-Y96baiXBXpwh1w3A)中也说道了，这里面的 Diff 主要是构建 currentInWorkProgress 的过程，同时得到 Effect List，给下一个阶段 commit 做准备。
...
`reconcileChildFibers` 就是 Diff 部分的主体代码，这个函数超级长，是一个包装函数，下面所有的 diff 代码都在这里面，详细的源码注释可以见[这里](https://link.zhihu.com/?target=https%3A//github.com/crazylxr/deep-in-react/blob/master/analysis/06-rencocilerChildren.md)。
...
![](https://pic2.zhimg.com/v2-93f76929239f84596a5c54ae6b04c411_b.jpg)
...
![](https://pic1.zhimg.com/v2-08e31bdfe0b22d850ca3772802c314a8_b.jpg)
...
![](https://pic2.zhimg.com/v2-e62740eca3f3a10f913772769fb72555_b.jpg)
...
然后通过 `$$typeof` 判断是 REACT\_ELEMENT\_TYPE 还是 REACT\_PORTAL\_TYPE，分别调用不同的复用逻辑，然后由于数组也是 Object ，所以这个 if 里面也有数组的复用逻辑。
...
以下效果动态演示来自于文章：[React Diff 源码分析](https://link.zhihu.com/?target=https%3A//slane.cn/2018/08/09/react-diff-yuan-ma-fen-xi/)，我觉得这个演示非常的形象，有助于理解。

这里渲染一个可输入的数组。  

![](https://pic1.zhimg.com/v2-bfc117e0d3cb8d82567e75b6b44be4dc_b.jpg)

当第一种情况，新数组遍历完了，老数组剩余直接删除（12345→1234 删除 5）：

![](https://pic3.zhimg.com/v2-52c30f4637d47ed6bef540e0c5b15c96_b.jpg)

新数组没完，老数组完了（1234→1234567 插入 567）：

![](https://pic1.zhimg.com/v2-5adace3c7788c77ae916004791299984_b.jpg)

移动的情况，即之前就存在这个元素，后续只是顺序改变（123 → 4321 插入4，移动2 1）：

![](https://pic2.zhimg.com/v2-461186c513fb320e6f958e040949f459_b.jpg)
...
更多的对于 React 原理相关，源码相关的内容，请关注我的 github：[Deep In React](https://link.zhihu.com/?target=https%3A//github.com/crazylxr/deep-in-react) 或者 个人博客：[桃园](https://link.zhihu.com/?target=http%3A//www.taoweng.site/)

我是桃翁，一个爱思考的前端er，想了解关于更多的前端相关的，请关注我的公号：「前端桃园」

![](https://pic4.zhimg.com/v2-a240df439a2de0b8712d2b00d0a3d657_b.jpg)